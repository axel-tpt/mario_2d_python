...
import pygame
# --- fichier
from mario_2d.module.world_builder import World
...
from mario_2d.module.texte import Bouton, Texte
from mario_2d.module.point import Point
from mario_2d.module.json_reader import *
...
class Game:
    def __init__(self, screen, w, h, menu, main):
        ...
        # Paramètre jeu
        self.pauseMenu = PauseMenu(screen, w, h, self, self.main)
